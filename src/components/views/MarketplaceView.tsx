...
const LISTINGS: ReadonlyArray<MarketplaceItem> = [
  {
    id: 'MP1',
    title: 'Compliance Sentinel Pro',
    description: 'Automated RLS audit + multi-tenant security guardrails for SaaS deployments.',
    price: '€199/mo',
    category: 'Security'
  },
  {
    id: 'MP2',
    title: 'Translator Swarm',
    description: '50+ language pairs with human validation workflow and certified output.',
    price: '€349/mo',
  ...
  },
  {
    ...
    description: 'Auto-reconcile Stripe payouts against your bookkeeper spreadsheets.',
    price: '€89/mo',
    category: 'Finance'
  },
  {
    id: 'MP4',
    title: 'Notion Sync Bridge',
    description: 'Two-way sync between your Notion workspace and the OMK database.',
    price: '€49/mo',
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300">
      <div className="text-center max-w-2xl mx-auto pt-2">
        <h1 className="text-3xl font-bold text-slate-900 mb-2">Upgrade Your OS</h1>
        <p className="text-slate-500">
          Plug-and-play modules to scale your agency without adding headcount.
        </p>
      </div>
